...
@property (nonatomic,retain) NSString<Optional> *origin_name;
@property (nonatomic,retain) NSString<Optional> *key;
@property (nonatomic,retain) NSString<Optional> *bucket;
...
@property (nonatomic,retain) NSString<Optional> *vcs_url;
@end
